...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  watch: {
    ...
    'cutomer.email': function cutomerEmail() {
  ...
  methods: {
    ...
    addToCart: function addToCart() {
      ...
      this.submitCart = true; // kirim data ke server
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/api/cart', this.cart).then(function (response) {
        setTimeout(function () {
          ...
          _this3.shoppingCart = response.data; // mengosongkan variabel
    ...
    searchCustomer: function searchCustomer() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/api/customer/search', {
        ...
        if (response.data.status == 'success') {
          ...
          _this6.customer.email = response.data.data[0].email;
          _this6.customer.name = response.data.data[0].name;
          _this6.customer.address = response.data.data[0].address;
          _this6.customer.phone = response.data.data[0].phone;
          _this6.resultStatus = true;
          _this6.formCustomer = true;
          _this6.messageEmail = '';
        } else if (response.data.status == 'emtpy') {
          _this6.customer.name = '';
          _this6.customer.address = '';
          _this6.customer.phone = '';
          _this6.resultStatus = true;
          _this6.formCustomer = false;
          _this6.messageEmail = '* Customer not found.';
        }
      })["catch"](function (error) {
        console.log(error);
      });
    ...
    sendOrder: function sendOrder() {
      ...
      this.orderMessage = '';
      this.message = '';
      this.messageEmail = ''; //jika data customer tidak kosong
...
__webpack_require__(/*! C:\xampp\htdocs\point-of-sale-laravel\resources\js\transaksi.js */"./resources/js/transaksi.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\point-of-sale-laravel\resources\sass\app.scss */"./resources/sass/app.scss");
